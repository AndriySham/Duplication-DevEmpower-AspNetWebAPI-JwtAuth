...
namespace DevEmpower_AspNetWebAPI_JwtAu.Core.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<AuthServiceResponseDto> LoginAsync(LoginDto loginDto)
        {
            ...
            var token = GenerateNewJsonToken(authClaims);
        ...
        public async Task<AuthServiceResponseDto> SeedRolesAsync()
        {
            ...
            {
                IsSucceed = true,
                Message = "Role Seeding Done Syccessfully"
            };
        }

        private string GenerateNewJsonToken(List<Claim> claims)
        {
